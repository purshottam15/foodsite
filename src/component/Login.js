...
const Login = () => {
  ...
  const formSubmit = async (e) => {
    ...
    if (user.email == 'admin@mail.com' && data.status == 200) {
      navigate('/adminfood')
    }
    if (data.status == 404) {
      setIsError(true);
    ...
    <>
      ...
      <div className="flex  w-full max-w-sm mx-auto overflow-hidden mt-4 text-black bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl">
       {/* <form method='POST' onSubmit={formSubmit}> */}
        ...
        <div className="hidden bg-cover lg:block lg:w-1/2" style={{backgroundImage: 'url("https://images.unsplash.com/photo-1611309454921-16cef3438ee0?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fGZvb2QlMjBiYWNrZ3JvdW5kfGVufDB8fDB8fHww")'}}></div>
        ...
        <div className="w-full px-6 py-8 md:px-8 lg:w-1/2">
          ...
          <a href="#" className="flex items-center justify-center mt-4 text-black transition-colors duration-300 transform border rounded-lg dark:border-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            <span className="w-5/6 px-4 py-3 font-bold text-center" onClick={loginHandler}>Sign in with Google</span>
          </a>
          ...
          <div className="flex items-center justify-between mt-4">
           ...
           <Link to="/signup"> <a href="#" className="text-xs text-gray-500 uppercase dark:text-gray-400 hover:underline">or sign up</a>
